...
// MODULAR_CXX_STATIC_VISIBLE rather than MODULAR_CXX_EXPORT, for the same
// reason as Init.h and Support/Context.h.  AsyncRT:Runtime is a static
// library, every consumer links this object directly, and dllimport here
// only sent them looking for an import table entry that no import library
// has.  The RuntimeGlobals shared library next door is a different matter
// and its declarations still say MODULAR_CXX_EXPORT.
MODULAR_CXX_STATIC_VISIBLE CPUDeviceRef
