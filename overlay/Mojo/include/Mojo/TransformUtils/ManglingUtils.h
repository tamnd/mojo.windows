...
// mangleParameterValues below returns a std::string and nothing here declared
// one. Both of the libstdc++ and libc++ builds get <string> transitively out of
// the forward declarations header and Microsoft's STL does not.
#include <string>
