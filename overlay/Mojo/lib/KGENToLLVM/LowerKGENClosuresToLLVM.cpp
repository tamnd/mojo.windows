...
private:
  ...
  LogicalResult generateClosureStruct(ConversionPatternRewriter &rewriter,
    ...
    // ArrayRef rather than a bare zero.  A zero of any integer type is still a
    // null pointer constant under -fms-compatibility, which makes the
    // DenseI64ArrayAttr overload of create viable and the call ambiguous.  The
    // long version of this is in LLVMLoweringUtils.cpp.
