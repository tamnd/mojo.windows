...
public:
  ...
  // Not MODULAR_CXX_EXPORT, because this is defined in Support:Context, which
  // is a static library, and on Windows the two arms of that macro are a
  // statement about a DLL boundary that is not here.  See SymbolExport.h.
  MODULAR_CXX_STATIC_VISIBLE ~Context();
