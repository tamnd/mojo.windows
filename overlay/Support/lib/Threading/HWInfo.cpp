...
// sched.h is out of the alphabetical block above for the same reason as in
// HWInfo.h next door: everything in this file that touches cpu_set_t or
// sched_getaffinity is already inside a HAVE_LINUX_X86_SYSTEM_INFO guard, so
// the include may as well be too. Windows has no sched.h.
