...
_KNOWN_FEATURES = {
    ...
    "system-darwin",
    "system-linux",
    # lit adds this one itself alongside system-darwin and system-linux. It was
    # missing here because no test had needed it yet, and a test that names a
    # feature this list does not know fails rather than being skipped.
    "system-windows",
    "tsan",
    "ubsan",
    "x86_64-linux",
